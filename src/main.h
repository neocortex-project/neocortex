...
static const int64 MAX_MONEY = 4893200000 * COIN; // maximum of 4893200000 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 960 / 250; // 5760 blocks found a day. Priority cutoff is 1 NEOC day / 250 bytes.
    }
...
public:
    ...
    {
        uint256 thash;
        neoscrypt(UBEGIN(nVersion),UBEGIN(thash), 0x3);
        return thash;
    }
